...
namespace FazelMan.Extentions
{
    ...
    {
        #region JSON
        internal static void FromJsonStringCustom(this RSA rsa, string jsonString)
        {
        ...
        internal static string ToJsonStringCustom(this RSA rsa, bool includePrivateParameters)
        {
        ...
        public static void FromXmlStringCustom(this RSA rsa, string xmlString)
        {
            RSAParameters parameters = new RSAParameters();
        ...
        public static string ToXmlStringCustom(this RSA rsa, bool includePrivateParameters)
        {
            RSAParameters parameters = rsa.ExportParameters(includePrivateParameters);
