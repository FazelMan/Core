...
namespace FazelMan.Sms.Kavenegar.Kavenegar
{
    public class SmsKavenegar : ISmsService
    {
        ...
        public SmsKavenegar(IConfiguration configuration)
        {
            ...
            Url = _configuration["FazelMan:Modulus:Sms.Kavenegar:URL"];
            PhoneNumber = _configuration["FazelMan:Modulus:Sms.Kavenegar:PhoneNumber"];
            ApiKey = _configuration["FazelMan:Modulus:Sms.Kavenegar:ApiKey"];
        }
