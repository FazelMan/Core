...
namespace FazelMan.Sms.Kavenegar.Kavenegar
{
    public class SmsKavenegar : ISmsService
    {
        ...
        public SmsKavenegar(IConfiguration configuration)
        {
            ...
            Url = _configuration["FazelMan:Modules:Sms.Kavenegar:URL"];
            PhoneNumber = _configuration["FazelMan:Modules:Sms.Kavenegar:PhoneNumber"];
            ApiKey = _configuration["FazelMan:Modules:Sms.Kavenegar:ApiKey"];
        }
        ...
        public async Task<bool> SendAsync(string templateName, string phoneNumber, string value)
        {
            try
            {
                ...
                var smsTemplateName = _configuration["FazelMan:Modules:Sms.Kavenegar:Templates:" + templateName];
